...
function get20s(array){
  ...
  // const checkYears = (yearsAlive) => {
  //   const years = yearsAlive.split(" - ");
  //   const born = parseInt(years[0]);
  //   const died = parseInt(years[1]);

  //   const inRange = (year) => year >= 1900 && year <= 2000;

  //   return inRange(born) && inRange(died);
  // }

  // return array.filter(a => checkYears(a.years));
...
function addArtist(array){
    const artist = {
      ...
      bio: 'Lorem ipsum dolor I don\'t remember the rest'
    };
